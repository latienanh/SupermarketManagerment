...
namespace Supermarket.Infrastructure.Repositories
{
    public class EmployeeRepository : RepositoryBase<Employee>, IEmployeeRepository
    {
        ...
        public async Task<Employee> updateEmployee(Employee entity, Guid id, string entityType, Guid userId)
        {
            var entityResult = await DbContext.Employees.FirstOrDefaultAsync(x => x.Id == id && x.IsDelete == false);
